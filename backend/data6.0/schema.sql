--------------------------------------------------------
--  Schema extract - QCB F010 / F013 / F014 / F015 (_DP tables)
...
--  DDL for Table QCB_F010_FILING_INFO_DP
CREATE TABLE "QCB_F010_FILING_INFO_DP" (
...
--  DDL for Table QCB_F010_RCM_IN_QTR_DP
CREATE TABLE "QCB_F010_RCM_IN_QTR_DP" (
    "SR_NO"                      NUMBER(20),
    "DESCRIPTION"                VARCHAR2(200),
...
--  DDL for Table QCB_F010_RCM_OUT_QTR_DP
CREATE TABLE "QCB_F010_RCM_OUT_QTR_DP" (
    "SR_NO"                      NUMBER(20),
    "DESCRIPTION"                VARCHAR2(200),
    "OVERNIGHT_LC"               NUMBER(20,2),
    "OVERNIGHT_USD"              NUMBER(20,2),
...
--  DDL for Table QCB_F013_BREAK_EXPOSURE_DP
CREATE TABLE "QCB_F013_BREAK_EXPOSURE_DP" (
...
--  DDL for Table QCB_F013_FILING_INFO_DP
CREATE TABLE "QCB_F013_FILING_INFO_DP" (
    "DESCRIPTION" VARCHAR2(200),
    "VALUE"       VARCHAR2(200),
    "CODE"        VARCHAR2(200),
    "RDATE"       DATE
